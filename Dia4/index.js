...
const libro1 = new Libro('978-0307474728', 'Cien años de soledad');

autor.agregarLibro(libro1);

console.log(autor.libros.length); // 1
console.log(libro1._autor.nombre); // "Gabriel García Márquez"

// Romper relación
autor.quitarLibro(libro1);

console.log(autor.libros.length); // 0
console.log(libro1._autor);       // null
